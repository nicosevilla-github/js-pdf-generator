	    ...
	    },
	    {
	    	stack: [
	    	{
	    		columns: [
	    		{
	    			text:'BASEBALL',
	    			width:'*',
	    			style:['text_align_center','fc_red','fs_bold','fs_italic','fsz_large']
	    		},
	    		{
	    			text:'',
	    			width: 180,		
            ...
            },
            {
                ...
                table: {
                	...
                	[
                        ...
                        {text: 'Left', style:['fs_bold','fsz_medium']},
                        {text: 'Right', style:['fs_bold','fsz_medium']}
                    ],
            	...
            	},
            	{
		            ...
		            },
		            {
		                ...
		                table: {
		                	...
		                	body: [
		                	[
		                        {text: 'TYPE', style:['fs_bold']}, 
		                        {text: 'SIZE', style:['fs_bold']}, 
		                        {text: 'NUMBER OF COLORS', style:['fs_bold']}, 
		                        {text: 'COLORS', style:['fs_bold']}
		                    ],
		                	[
		                        {text: 'N/A'}, 
		                        {text: 'N/A'}, 
