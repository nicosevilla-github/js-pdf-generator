...
var images = [
	{ preview_thumbnail: 'https://richardson.picarioxpo.com/951_FINAL.pfs?1=1&width=1340&p.tn=Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg'},
	{ front_thumbnail: 'https://richardson.picarioxpo.com/951_front.pfs?1=1&width=1340&p.tn=Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg' },
	{ back_thumbnail: 'https://richardson.picarioxpo.com/951_back.pfs?1=1&width=1340&p.tn=Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg' },
	{ left_thumbnail: 'https://richardson.picarioxpo.com/951_left.pfs?1=1&width=1340&p.tn=Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg' },
	{ right_thumbnail: 'https://richardson.picarioxpo.com/951_right.pfs?1=1&width=1340&p.tn=Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg,Heather%20Grey.jpg' }
];
var dataUrls = [{}];
        	...
        	table: {
                ...
                body: [
                    ...
                    [
                    {
		    			...
		    			{
		    				text:'CANVAS DUCK CLOTH/POLY-CANVAS'
		    			}
		    			]
		    		},
                    {
   ...
   //              ]
	  //       },
...

			{
				...
				{
					width: 'auto',
					style:['fsz_medium','fc_dark'],
	                stack:[
	                {
	                    text:'CAP DETAILS',
	                    style: ['fc_red','fs_bold','fsz_large']
	                },
	                {
	                    text:[
                        {
	            ...
	            },
	            {
	            	...
	            	table: {
	            		...
	            		{
	            			rowSpan: 2,
	            			image: dataUrls.preview_thumbnail,
							width: 300,
	            		},
	            		{
            ...
            },
            {
                ...
                table: {
                	...
                	body: [
                	[
                        {text: 'FRONT', style:['fs_bold','fsz_medium']},
                        {text: 'BACK', style:['fs_bold','fsz_medium']},
                        {text: 'WEARER’S LEFT', style:['fs_bold','fsz_medium']},
                        {text: 'WEARER’S RIGHT', style:['fs_bold','fsz_medium']}
                    ],
                    ...
                    [
                    {
                    	stack:[
                    	{
                    		table: {
                    			...
                    			body: [
                    			[
                    			{text: 'DETAILS', style:['fs_bold','fsz_medium'], colSpan: 2, margin: [0,0,0,5]},''
                    			],
